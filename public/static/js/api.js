...
function orderStore(){
    ...
    var clause1 = $("input[name='clause1']:checked").val();
    var clause2 = $("input[name='clause2']:checked").val();
    var clause3 = $("input[name='clause3']:checked").val();



    if(!name){
        if(is_mobile_domain){
            $('input[name="name"]').center()
        }

        $('input[name="name"]').focus();
        $('input[name="name"]').contip({
            align: is_mobile_domain?'bottom':'right',
            html: '請填寫收件人姓名',
            fade: 360,
            opacity:0.6,
            delay_out:100,
    ...
    if(order_type > 0){
        ...
        if(!address){
            if(is_mobile_domain){
                $('input[name="address"]').center()
            }
            $('input[name="address"]').focus();
            $('input[name="address"]').contip({
                align: is_mobile_domain?'top':'right',
                html: '請填寫詳細地址',
                fade: 360,
                opacity:0.6,
                delay_out:100,
    ...
    if(!clause2){
        ...
        $("input[name='clause2']").contip({
            align: is_mobile_domain?'bottom':'left',
            html: '需勾選此項',
            fade: 360,
            opacity:0.6,
            delay_out:100,
